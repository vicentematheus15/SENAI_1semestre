function maiorString(nomes){
    let nome = ""
    for(i = 0; i < nomes.length ; i++){ //faz o loop enquanto o i for menor que a quantidade de itens (nesse exemplo é 5)
        ...
        if(nome_temp.length > nome.length){ //se o nome for maior que o nome anterior
            ...
            continue //se nao for maior, nao guarda o nome em lugar nenhum e continua executando o loop
        }
    }
